...
object RxToast {
    ...
    fun warning(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            appContext,
            message,
            getDrawable(appContext, R.mipmap.ic_error_outline_white_48dp),
            DEFAULT_TEXT_COLOR,
            WARNING_COLOR,
            duration,
            withIcon,
    ...
    fun info(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            appContext,
            message,
            getDrawable(appContext, R.mipmap.ic_info_outline_white_48dp),
            DEFAULT_TEXT_COLOR,
            INFO_COLOR,
            duration,
            withIcon,
    ...
    fun success(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            appContext,
            message,
            getDrawable(appContext, R.mipmap.ic_check_white_48dp),
            DEFAULT_TEXT_COLOR,
            SUCCESS_COLOR,
            duration,
            withIcon,
    ...
    fun error(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            appContext,
            message,
            getDrawable(appContext, R.mipmap.ic_clear_white_48dp),
            DEFAULT_TEXT_COLOR,
            ERROR_COLOR,
            duration,
            withIcon,
    ...
    fun custom(
        ...
        drawableFrame = if (shouldTint) {
            ...
            getDrawable(context, R.mipmap.toast_frame)
        }
    ...
    fun showToastLong(resId: Int) {
        Toast.makeText(appContext, appContext.getString(resId), Toast.LENGTH_LONG).show()
    }
    ...
    fun showToast(resId: Int) {
        if (mToast == null) {
            mToast = Toast.makeText(appContext, appContext.getString(resId), Toast.LENGTH_LONG)
        } else {
            mToast?.setText(appContext.getString(resId))
        }
        mToast?.show()
    }
