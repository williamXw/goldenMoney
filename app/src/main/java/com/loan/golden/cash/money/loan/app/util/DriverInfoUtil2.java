...
//    }
    ...
    public static List<String> getAbis(Activity context) {
...
//    }
    ...
    private static DeviceInfoParam.ModelBean.GeneralDataBean getGeneralData(Activity context) {
