...
import com.loan.golden.cash.money.loan.comm.RxConstants
...
class RxDataTool {
    companion object {
        ...
        fun isContainSpace(value: String): Boolean {
            return value.contains(RxConstants.SPACE)
        }
        ...
        fun formatCard(cardNo: String): String {
            ...
            var card = ""
            card = cardNo.substring(0, 4) + RxConstants.SPACE + cardNo.substring(
                4,
                8
            ) + RxConstants.SPACE + cardNo.substring(8, 12) + RxConstants.SPACE
            card += cardNo.substring(cardNo.length - 4)
            return card
        }
