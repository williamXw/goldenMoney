    ...
    public static String[] getReadPermissionArray(int chooseMode) {
        if (SdkVersionUtils.isTIRAMISU()) {
            if (chooseMode == SelectMimeType.ofImage()) {
                return new String[]{READ_MEDIA_IMAGES, Manifest.permission.READ_MEDIA_IMAGES};
            } else if (chooseMode == SelectMimeType.ofVideo()) {
                return new String[]{READ_MEDIA_VIDEO, Manifest.permission.READ_MEDIA_VIDEO};
            } else if (chooseMode == SelectMimeType.ofAudio()) {
                return new String[]{READ_MEDIA_AUDIO, Manifest.permission.READ_MEDIA_AUDIO};
            } else {
